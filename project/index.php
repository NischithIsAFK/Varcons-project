...
<head>
    ...
    <title>Gbois Fashion Website</title>
...
<body>
    ...
    <section class="banner_part" style="background: url(img/ban.png);">
        <div class="container">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        ...
                        <div class="hover_text">
                            <a href="category.php?cat=Gents" class="btn_2">Shop For Men</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        ...
                        <div class="hover_text">
                            <a href="category.php?cat=Ladies" class="btn_2">Shop For Women</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
