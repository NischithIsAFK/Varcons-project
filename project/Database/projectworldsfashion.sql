...
(1, 'Akshay', 'Prasad', 'ap@gmail.com', '123', '', '', 'cus');
...
('OD2047TX12402420220906', 'bhilai', 'durg', 'durg', 490021, 'ram kumar', 'Cash On Delivery', 8, 'Shipped', '2022-09-06 10:43:54'),
('OD3673TX18460520200320', 'Negombo Road, Ja-Ela', '', '', 0, '0789985468', 'BT', 1, 'Shipped', '2022-09-06 10:43:50'),
('OD4085TX05240920200322', 'asdasd', 'asd', 'asdasd', 346346, 'sadas', 'Bank Transfer', 1, 'Shipped', '2022-09-06 10:43:42'),
...
(29, 'OD2047TX12402420220906', 6, 1, '1000', 'md');
...
--
ALTER TABLE `admin`
 ADD PRIMARY KEY (`idAdmin`), ADD UNIQUE KEY `email_UNIQUE` (`email`);
...
ALTER TABLE `customer`
 ADD PRIMARY KEY (`idCustomer`), ADD UNIQUE KEY `email` (`email`);

--
-- Indexes for table `image`
--
ALTER TABLE `image`
 ADD PRIMARY KEY (`imgid`,`Product_idProduct`,`Product_Brand_idBrand`), ADD KEY `fk_Image_Product1_idx` (`Product_idProduct`,`Product_Brand_idBrand`);
...
--
ALTER TABLE `product`
 ADD PRIMARY KEY (`idProduct`,`Brand_idBrand`), ADD KEY `fk_Product_Brand_idx` (`Brand_idBrand`);
